...
EtaPhiEventCleaner::EtaPhiEventCleaner(Context& ctx, int min_run_, int max_run_, float min_eta_, float max_eta_, float min_phi_, float max_phi_,
  string JetCollection_, string TopJetCollection_, bool doElectrons_, bool doMuons_):
...
HEMCleanerSelection::HEMCleanerSelection(Context& ctx, string JetCollection, string TopJetCollection, bool doElectrons, bool doMuons):
