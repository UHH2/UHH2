...
JetResolutionSmearer::JetResolutionSmearer(uhh2::Context & ctx){
  ...
  if (year == Year::is2016v2 || year == Year::is2016v3) {
    ...
    version = "Autumn18_V7";
  }  else if (year == Year::isUL16_preVFP) { // TODO fix this with new values
    version = "Summer16_25nsV1";
  }  else if (year == Year::isUL16_postVFP) { // TODO fix this with new values
    version = "Summer16_25nsV1";
  }  else if (year == Year::isUL17) { // TODO fix this with new values
    version = "Fall17_V3";
  } else if (year == Year::isUL17) { // TODO fix this with new values
    version = "Autumn18_V7";
  } else {
