...
public:
  explicit GenericJetResolutionSmearer(uhh2::Context&, const std::string& recj="jets", const std::string& genj="genjets", const TString& sfFilename="", const TString& resFilename="");
