...
#            '/store/mc/RunIIFall17MiniAOD/QCD_HT1000to1500_TuneCP5_13TeV-madgraph-pythia8/MINIAODSIM/94X_mc2017_realistic_v10-v1/00000/06AD81E7-4BF9-E711-9DD6-FA163E63BF60.root'
                            ]),
...
# Add AK4 producers to store jets with low pt
ak4_label = "AK4PFPUPPI"
ak4puppi_patname = 'patJets' + ak4_label
print 'Adding', ak4puppi_patname
addJetCollection(process,
                 labelName=ak4_label,
                 jetSource=cms.InputTag('ak8PuppiJets'),
                 algo='AK',
...
delattr(process, "selectedPatJets"+cap(ak4_label))
# For data, turn off every gen-related part - can't do this via
# addJetCollection annoyingly
if useData:
    producer = getattr(process, ak4puppi_patname)
    modify_patjetproducer_for_data(process, producer)

ak4_label = "AK4PFCHS"
ak4chs_patname = 'patJets' + ak4_label
print 'Adding', ak4chs_patname
addJetCollection(process,
                 labelName=ak4_label,
                 jetSource=cms.InputTag('ak8CHSJets'),
                 algo='AK',
...
# addJetCollection annoyingly
if useData:
    producer = getattr(process, ak4chs_patname)
    modify_patjetproducer_for_data(process, producer)
...
####### Gen XCONE jets
process.genxconeCHS = cms.EDProducer("GenXConeProducer",
    src=cms.InputTag("packedGenParticlesForJetsNoNu"),
    usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
    NJets = cms.uint32(2),          # number of fatjets
    RJets = cms.double(1.2),        # cone radius of fatjets
...
task.add(process.genxconeCHS)

process.genxconeCHS4jets04 = cms.EDProducer("GenXConeProducer",
    src=cms.InputTag("packedGenParticlesForJetsNoNu"),
    usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
    NJets = cms.uint32(4),          # number of fatjets
    RJets = cms.double(0.4),        # cone radius of fatjets
...
task.add(process.genxconeCHS4jets04)

process.genxconeCHS3jets04 = cms.EDProducer("GenXConeProducer",
    src=cms.InputTag("packedGenParticlesForJetsNoNu"),
    usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
    NJets = cms.uint32(3),          # number of fatjets
    RJets = cms.double(0.4),        # cone radius of fatjets
...
task.add(process.genxconeCHS3jets04)

process.genxconeCHS2jets04 = cms.EDProducer("GenXConeProducer",
    src=cms.InputTag("packedGenParticlesForJetsNoNu"),
    usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
    NJets = cms.uint32(2),          # number of fatjets
    RJets = cms.double(0.4),        # cone radius of fatjets
...
task.add(process.genxconeCHS2jets04)


# process.genxconeCHS4jets08 = cms.EDProducer("GenXConeProducer",
#     src=cms.InputTag("packedGenParticlesForJetsNoNu"),
#     usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
#     NJets = cms.uint32(4),          # number of fatjets
#     RJets = cms.double(0.8),        # cone radius of fatjets
...
#     DRLeptonJet = cms.double(999),  # here you can specify the maximum distance for a lepton-jet match
# )
# task.add(process.genxconeCHS4jets08)

# process.genxconeCHS3jets08 = cms.EDProducer("GenXConeProducer",
#     src=cms.InputTag("packedGenParticlesForJetsNoNu"),
#     usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
#     NJets = cms.uint32(3),          # number of fatjets
#     RJets = cms.double(0.8),        # cone radius of fatjets
...
#     DRLeptonJet = cms.double(999),  # here you can specify the maximum distance for a lepton-jet match
# )
# task.add(process.genxconeCHS3jets08)

# process.genxconeCHS2jets08 = cms.EDProducer("GenXConeProducer",
#     src=cms.InputTag("packedGenParticlesForJetsNoNu"),
#     usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
#     NJets = cms.uint32(2),          # number of fatjets
#     RJets = cms.double(0.8),        # cone radius of fatjets
...
#     DRLeptonJet = cms.double(999),  # here you can specify the maximum distance for a lepton-jet match
# )
# task.add(process.genxconeCHS2jets08)
...
#                                doElectrons=cms.bool(False),
                                ...
                                jet_sources=cms.vstring(
                                    ...
                                    "slimmedJets", "updatedPatJetsSlimmedJetsPuppi", "updatedPatJetsPatJetsAK8PFPUPPI", 
                                    ak8chs_patname, ak4chs_patname, ak8puppi_patname, ak4puppi_patname),
                                jet_ptmin=cms.double(2.0),
...
#                                    cms.InputTag("xconePuppi"),
                                ...
                                GenXCone_sources=cms.VInputTag(
                                    cms.InputTag("genxconeCHS2jets04"),
                                    cms.InputTag("genxconeCHS3jets04"),
                                    cms.InputTag("genxconeCHS4jets04"),
                                    # cms.InputTag("genxconeCHS2jets08"),
                                    # cms.InputTag("genxconeCHS3jets08"),
                                    # cms.InputTag("genxconeCHS4jets08"),
