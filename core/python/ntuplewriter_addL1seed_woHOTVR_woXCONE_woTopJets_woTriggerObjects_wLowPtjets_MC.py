...
process.ak8GenJets = ak8PFJets.clone(
...
task.add(process.ak8GenJets)

process.ak4GenJets = ak8PFJets.clone(
    src=cms.InputTag('packedGenParticlesForJetsNoNu'),
    jetType='GenJet',
    doAreaFastjet=True,
    jetPtMin=2.,
...
# for JEC purposes, cluster AK8 and AK4 jets but with lower pt (compared to higher
...
#                                doL1seed=cms.bool(False),
                                ...
                                genjet_sources=cms.vstring(
                                    ...
                                    "slimmedGenJets", "slimmedGenJetsAK8","ak8GenJets","ak4GenJets"),
