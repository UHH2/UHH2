...
process.source = cms.Source("PoolSource", fileNames  = cms.untracked.vstring([
            ...
            #'/store/user/akaravdi/JetHT/crab_pickEvents_METtail/170626_154231/0000/pickevents_1.root'
            #'/store/user/akaravdi/SingleElectron/crab_pickEvents/170626_204933/0000/pickevents_1.root'
            '/store/user/akaravdi/SingleElectron/crab_pickEvents/170627_051927/0000/pickevents_1.root'
            ]),
...
#addMETCollection(process, labelName='patPFMetCHS', metSource='pfMetCHS') # RAW MET
...
load_elecPFMiniIso(process, 'elecPFMiniIsoSequenceSTAND', algo = 'STAND',
 # src = 'selectedElectrons',
  #                 src = 'slimmedElectronsBeforeGSFix',
...
# process.egmGsfElectronIDs.physicsObjectSrc = cms.InputTag('slimmedElectronsBeforeGSFix')
# process.electronMVAValueMapProducer.srcMiniAOD = cms.InputTag('slimmedElectronsBeforeGSFix')
...
process.MyNtuple = cms.EDFilter('NtupleWriter',
        ...
        photon_sources = cms.vstring("selectedPhotons","slimmedPhotonsBeforeGSFix","slimmedPhotons"),
