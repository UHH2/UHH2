...
#process.patPFMet.addGenMET = cms.bool(not useData)
...
#process.slMETsCHS.addGenMET = cms.bool(not useData) 
...
#        higgstag_sources = cms.vstring("patJetsAK8PFCHS","patJetsAK8PFCHS","patJetsCa15CHSJets","patJetsCa15PuppiJets","patJetsAk8PuppiJetsFat"), #TEST
        ...
        gentopjet_sources = cms.VInputTag(cms.vstring("ak8GenJetsSoftDrop")),
