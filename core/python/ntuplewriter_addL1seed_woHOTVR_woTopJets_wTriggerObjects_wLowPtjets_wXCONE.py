...
process.xconeCHS4jets08w2subjets = cms.EDProducer("XConeProducer",
    src=cms.InputTag("chs"),
    usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
    NJets = cms.uint32(4),          # number of fatjets
    RJets = cms.double(0.8),        # cone radius of fatjets
    BetaJets = cms.double(2.0),     # conical mesure (beta = 2.0 is XCone default)
    NSubJets = cms.uint32(2),       # number of subjets in each fatjet
    RSubJets = cms.double(0.4),     # cone radius of subjetSrc
    BetaSubJets = cms.double(2.0)   # conical mesure for subjets
)
task.add(process.xconeCHS4jets08w2subjets)

process.xconeCHS3jets08w2subjets = cms.EDProducer("XConeProducer",
    src=cms.InputTag("chs"),
    usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
    NJets = cms.uint32(3),          # number of fatjets
    RJets = cms.double(0.8),        # cone radius of fatjets
...
task.add(process.xconeCHS3jets08w2subjets)

process.xconeCHS2jets08w2subjets = cms.EDProducer("XConeProducer",
    src=cms.InputTag("chs"),
    usePseudoXCone=usePseudoXCone,  # use PseudoXCone (faster) or XCone
    NJets = cms.uint32(2),          # number of fatjets
    RJets = cms.double(0.8),        # cone radius of fatjets
...
task.add(process.xconeCHS2jets08w2subjets)
...
#                                doXCone=cms.bool(False),
                                ...
                                XCone_sources=cms.VInputTag(
                                    ...
                                    cms.InputTag("xconeCHS4jets08w2subjets"),
                                    cms.InputTag("xconeCHS3jets08w2subjets"),
                                    cms.InputTag("xconeCHS2jets08w2subjets"),
                                ),
